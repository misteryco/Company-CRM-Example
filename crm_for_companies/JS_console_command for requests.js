...
//
//
// curl -u yd:123 'http://localhost:8000/api_employees/update/1' \
//   -X 'PUT' \
//   -H 'Accept: text/html; q=1.0, */*' \
//   -H 'Accept-Language: en-US,en;q=0.9' \
//   -H 'Connection: keep-alive' \
//   -H 'Content-Type: application/json' \
//   -H 'Cookie: Pycharm-be7a6097=7d88d31b-0e01-47a4-8f25-2c56d0fddab7; csrftoken=njleBggRyR0xUHFhemVQEqJhGKjEATVM; sessionid=a3dut6s1plsjpzf2v61lubfyc423p5ze; tabstyle=raw-tab' \
//   -H 'Origin: http://localhost:8000' \
//   -H 'Referer: http://localhost:8000/api_employees/update/1' \
...
//   -H 'X-CSRFTOKEN: zea0q7mt6VG3CSR3XMx5hw6OsK3tY1wKMnl4RdsauCwqmpma1YiLLMFVYkcXoKhm' \
